"""
SQLite Database Manager for P.U.L.S.E. (Prime Uminda's Learning System Engine)
...
class DBManager:
    """Manages SQLite database operations for P.U.L.S.E."""

    def __init__(self, db_path="memory/pulse.db"):
        """Initialize the database manager."""
        self.logger = PulseLogger("DBManager")
