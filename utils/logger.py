"""
Structured logging utilities for General Pulse
...
# Default log file
DEFAULT_LOG_FILE = os.path.join(LOG_DIR, "general_pulse.log")
...
def setup_logger(log_level=logging.INFO):
    ...
    try:
        ...
        logger = structlog.get_logger("general_pulse")
...
class GeneralPulseLogger:
    """
    Centralized logger for General Pulse using structlog
...
default_logger = GeneralPulseLogger("GeneralPulse") 