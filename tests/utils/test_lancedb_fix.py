...
async def test_lancedb():
    ...
    print(f"Testing LanceDB initialization (version: {LANCEDB_VERSION}, API: {'modern' if LANCEDB_MODERN else 'legacy'}, Vector class: {'available' if HAS_LANCEDB_VECTOR else 'not available'})")
